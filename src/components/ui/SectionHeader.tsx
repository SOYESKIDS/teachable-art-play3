...
export function SectionHeader({
  ...
  return (
    ...
    >
      ...
      <h2 className="max-w-3xl whitespace-pre-line text-4xl font-bold leading-[1.25] text-navy sm:text-[2.75rem] lg:text-[3.25rem] xl:text-[3.5rem]">
        {headline}
      </h2>
      {subCopy && (
        <p className="max-w-2xl whitespace-pre-line text-lg leading-[1.7] text-navy/70 sm:text-xl">
          {subCopy}
        </p>
      )}
    </div>
